...
wwv_flow_imp_shared.create_template(
 p_id=>wwv_flow_imp.id(294267649979215811)
,p_theme_id=>42
,p_name=>'Modal Dialog'
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(319796232723547436)
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(319796710015547436)
,p_page_template_id=>wwv_flow_imp.id(294267649979215811)
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(319797180510547437)
,p_page_template_id=>wwv_flow_imp.id(294267649979215811)
