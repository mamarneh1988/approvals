...
wwv_flow_imp_page.create_page(
 p_id=>6
,p_name=>'Approvals Administration'
,p_alias=>'APPROVALS-ADMINISTRATION'
,p_step_title=>'Approvals Administration'
,p_autocomplete_on_off=>'OFF'
,p_page_template_options=>'#DEFAULT#'
,p_protection_level=>'C'
,p_page_component_map=>'24'
,p_last_updated_by=>'STEVE'
,p_last_upd_yyyymmddhh24miss=>'20221101090240'
);
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(363216315003936959)
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(363217463519936962)
,p_plug_name=>'Admin Tasks - Smart Filters'
,p_parent_plug_id=>wwv_flow_imp.id(363216315003936959)
,p_region_template_options=>'#DEFAULT#'
,p_plug_template=>wwv_flow_imp.id(294284314976215830)
,p_plug_display_sequence=>10
,p_plug_display_point=>'SMART_FILTERS'
,p_plug_source_type=>'NATIVE_SMART_FILTERS'
,p_filtered_region_id=>wwv_flow_imp.id(363217527515936962)
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(363217527515936962)
...
,p_plug_query_options=>'DERIVED_REPORT_COLUMNS'
,p_plug_query_no_data_found=>'There are no tasks for you to administer'
,p_no_data_found_icon_classes=>'fa-clipboard-check-alt fa-lg'
,p_show_total_row_count=>false
);
wwv_flow_imp_page.create_card(
 p_id=>wwv_flow_imp.id(363221775239936968)
,p_region_id=>wwv_flow_imp.id(363217527515936962)
,p_layout_type=>'ROW'
...
wwv_flow_imp_page.create_card_action(
 p_id=>wwv_flow_imp.id(363222348420936969)
,p_card_id=>wwv_flow_imp.id(363221775239936968)
,p_action_type=>'TITLE'
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(2650302483598326198)
...
,p_plug_source=>'<p>This page shows a user the approval tasks they can administer. Use the search box to filter the list. Toggle between seeing the tasks ordered by Create Date or Due Date using the order by page item. The page was created using the <strong>Create Pa'
||'ge</strong> wizard, choosing <strong>Unified Task List</strong> page type, and picking a <strong>Report Context</strong> of "Admin Tasks".</p>'
,p_plug_query_options=>'DERIVED_REPORT_COLUMNS'
,p_attribute_01=>'N'
,p_attribute_02=>'HTML'
);
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(363217064963936961)
,p_name=>'P6_TASK_ID'
,p_item_sequence=>20
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(363217944609936964)
,p_name=>'P6_SEARCH'
,p_item_sequence=>10
,p_item_plug_id=>wwv_flow_imp.id(363217463519936962)
,p_prompt=>'Search'
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(363218343503936964)
,p_name=>'P6_DUE'
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(363218736449936965)
,p_name=>'P6_TYPE'
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(363219166292936965)
,p_name=>'P6_PRIORITY'
,p_source_data_type=>'NUMBER'
,p_item_sequence=>40
,p_item_plug_id=>wwv_flow_imp.id(363217463519936962)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(363219479260936966)
,p_name=>'P6_STATE'
,p_source_data_type=>'VARCHAR2'
,p_item_sequence=>50
,p_item_plug_id=>wwv_flow_imp.id(363217463519936962)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(363219880977936966)
,p_name=>'P6_OUTCOME'
,p_source_data_type=>'VARCHAR2'
,p_item_sequence=>60
,p_item_plug_id=>wwv_flow_imp.id(363217463519936962)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(363220316144936966)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(363220683428936967)
,p_name=>'P6_INITIATOR'
,p_source_data_type=>'VARCHAR2'
,p_item_sequence=>80
,p_item_plug_id=>wwv_flow_imp.id(363217463519936962)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(363221092052936968)
,p_name=>'P6_INITIATED'
,p_source_data_type=>'NUMBER'
,p_item_sequence=>90
,p_item_plug_id=>wwv_flow_imp.id(363217463519936962)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(363222920612936970)
,p_name=>'P6_SORT_BY'
,p_item_sequence=>10
,p_item_plug_id=>wwv_flow_imp.id(363217527515936962)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(363223316125936971)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(367401445210623133)
,p_name=>'P6_OWNER'
,p_source_data_type=>'VARCHAR2'
,p_item_sequence=>100
,p_item_plug_id=>wwv_flow_imp.id(363217463519936962)
...
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(363223727588936971)
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(363224127745936972)
,p_event_id=>wwv_flow_imp.id(363223727588936971)
,p_event_result=>'TRUE'
...
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(363224585281936973)
,p_name=>'Refresh - Admin Tasks - Report'
,p_event_sequence=>20
,p_triggering_element_type=>'REGION'
,p_triggering_region_id=>wwv_flow_imp.id(363217527515936962)
,p_bind_type=>'bind'
,p_execution_type=>'IMMEDIATE'
,p_bind_event_type=>'apexafterclosecanceldialog'
);
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(363225015498936973)
,p_event_id=>wwv_flow_imp.id(363224585281936973)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'N'
,p_action=>'NATIVE_REFRESH'
,p_affected_elements_type=>'REGION'
,p_affected_region_id=>wwv_flow_imp.id(363217527515936962)
);
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(363225487672936974)
,p_event_id=>wwv_flow_imp.id(363224585281936973)
,p_event_result=>'TRUE'
...
,p_action=>'NATIVE_REFRESH'
,p_affected_elements_type=>'REGION'
,p_affected_region_id=>wwv_flow_imp.id(363217463519936962)
);
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(363226003170936975)
,p_name=>'Refresh - Admin Tasks - Report'
,p_event_sequence=>30
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(363226376910936975)
,p_event_id=>wwv_flow_imp.id(363226003170936975)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'N'
,p_action=>'NATIVE_REFRESH'
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(363226930928936976)
,p_event_id=>wwv_flow_imp.id(363226003170936975)
,p_event_result=>'TRUE'
,p_action_sequence=>20
,p_execute_on_page_init=>'N'
