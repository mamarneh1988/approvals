...
wwv_flow_imp_shared.create_template(
 p_id=>wwv_flow_imp.id(294276215698215820)
,p_theme_id=>42
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(319819919926547457)
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(319820423319547457)
,p_page_template_id=>wwv_flow_imp.id(294276215698215820)
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(319820943601547458)
,p_page_template_id=>wwv_flow_imp.id(294276215698215820)
