...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(294340864588215882)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(319987521318547665)
,p_plug_template_id=>wwv_flow_imp.id(294340864588215882)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(319988043865547665)
,p_plug_template_id=>wwv_flow_imp.id(294340864588215882)
,p_name=>'Create'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(319988490153547666)
,p_plug_template_id=>wwv_flow_imp.id(294340864588215882)
,p_name=>'Edit'
,p_placeholder=>'EDIT'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(319989034818547666)
,p_plug_template_id=>wwv_flow_imp.id(294340864588215882)
,p_name=>'Next'
,p_placeholder=>'NEXT'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(319989535035547666)
,p_plug_template_id=>wwv_flow_imp.id(294340864588215882)
,p_name=>'Sub Regions'
