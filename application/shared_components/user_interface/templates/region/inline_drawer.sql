...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(294328738628215873)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(319956975115547629)
,p_plug_template_id=>wwv_flow_imp.id(294328738628215873)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(319957485165547630)
,p_plug_template_id=>wwv_flow_imp.id(294328738628215873)
,p_name=>'Close'
,p_placeholder=>'CLOSE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(319958026584547630)
,p_plug_template_id=>wwv_flow_imp.id(294328738628215873)
,p_name=>'Create'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(319958514862547631)
,p_plug_template_id=>wwv_flow_imp.id(294328738628215873)
,p_name=>'Delete'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(319958983686547631)
,p_plug_template_id=>wwv_flow_imp.id(294328738628215873)
,p_name=>'Edit'
,p_placeholder=>'EDIT'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(319959478459547632)
,p_plug_template_id=>wwv_flow_imp.id(294328738628215873)
,p_name=>'Next'
,p_placeholder=>'NEXT'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(319960070124547633)
,p_plug_template_id=>wwv_flow_imp.id(294328738628215873)
,p_name=>'Previous'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(319960495605547633)
,p_plug_template_id=>wwv_flow_imp.id(294328738628215873)
,p_name=>'Sub Regions'
