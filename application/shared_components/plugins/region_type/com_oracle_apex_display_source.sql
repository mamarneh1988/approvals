...
wwv_flow_imp_shared.create_plugin(
 p_id=>wwv_flow_imp.id(781069654673660)
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(781233036673663)
,p_plugin_id=>wwv_flow_imp.id(781069654673660)
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(781625276673670)
,p_plugin_id=>wwv_flow_imp.id(781069654673660)
,p_attribute_scope=>'COMPONENT'
