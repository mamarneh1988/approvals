...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(294284314976215830)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(319840411658547482)
,p_plug_template_id=>wwv_flow_imp.id(294284314976215830)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(319840907657547482)
,p_plug_template_id=>wwv_flow_imp.id(294284314976215830)
,p_name=>'Next'
,p_placeholder=>'NEXT'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(319841389706547483)
,p_plug_template_id=>wwv_flow_imp.id(294284314976215830)
,p_name=>'Previous'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(319841939751547483)
,p_plug_template_id=>wwv_flow_imp.id(294284314976215830)
,p_name=>'Sub Regions'
