...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(320045094770547726)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(320045664462547728)
,p_plug_template_id=>wwv_flow_imp.id(320045094770547726)
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(320046101153547729)
,p_plug_template_id=>wwv_flow_imp.id(320045094770547726)
,p_name=>'Search Field'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(320046615436547729)
,p_plug_template_id=>wwv_flow_imp.id(320045094770547726)
,p_name=>'Sub Regions'
