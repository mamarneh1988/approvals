...
wwv_flow_imp_shared.create_template(
 p_id=>wwv_flow_imp.id(294269120227215813)
,p_theme_id=>42
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(319803022319547442)
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(319803564454547442)
,p_page_template_id=>wwv_flow_imp.id(294269120227215813)
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(319804043070547443)
,p_page_template_id=>wwv_flow_imp.id(294269120227215813)
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(319804544884547443)
,p_page_template_id=>wwv_flow_imp.id(294269120227215813)
,p_name=>'Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(319805046561547444)
,p_page_template_id=>wwv_flow_imp.id(294269120227215813)
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(319805565099547445)
,p_page_template_id=>wwv_flow_imp.id(294269120227215813)
,p_name=>'Right Column'
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(319806006734547445)
,p_page_template_id=>wwv_flow_imp.id(294269120227215813)
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(319806540582547445)
,p_page_template_id=>wwv_flow_imp.id(294269120227215813)
,p_name=>'Footer'
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(319806981955547446)
,p_page_template_id=>wwv_flow_imp.id(294269120227215813)
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(319807541669547446)
,p_page_template_id=>wwv_flow_imp.id(294269120227215813)
,p_name=>'Banner'
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(319807985006547446)
,p_page_template_id=>wwv_flow_imp.id(294269120227215813)
