...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(294353114462215893)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(320021162277547697)
,p_plug_template_id=>wwv_flow_imp.id(294353114462215893)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(320021580244547697)
,p_plug_template_id=>wwv_flow_imp.id(294353114462215893)
,p_name=>'Tabs'
