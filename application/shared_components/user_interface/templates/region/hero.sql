...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(294315568240215861)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(319923017742547591)
,p_plug_template_id=>wwv_flow_imp.id(294315568240215861)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(319923541797547591)
,p_plug_template_id=>wwv_flow_imp.id(294315568240215861)
,p_name=>'Next'
,p_placeholder=>'NEXT'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(319923981471547592)
,p_plug_template_id=>wwv_flow_imp.id(294315568240215861)
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(319924498103547592)
,p_plug_template_id=>wwv_flow_imp.id(294315568240215861)
,p_name=>'Sub Regions'
