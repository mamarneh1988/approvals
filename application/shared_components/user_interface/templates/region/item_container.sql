...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(320049400969547732)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(320049939842547732)
,p_plug_template_id=>wwv_flow_imp.id(320049400969547732)
,p_name=>'Item'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(320050386554547733)
,p_plug_template_id=>wwv_flow_imp.id(320049400969547732)
,p_name=>'Button End'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(320050945171547734)
,p_plug_template_id=>wwv_flow_imp.id(320049400969547732)
,p_name=>'Button Start'
