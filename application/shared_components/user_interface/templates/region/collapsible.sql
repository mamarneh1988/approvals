...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(294301809631215843)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(319886714287547539)
,p_plug_template_id=>wwv_flow_imp.id(294301809631215843)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(319887264625547540)
,p_plug_template_id=>wwv_flow_imp.id(294301809631215843)
,p_name=>'Change'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(319887769964547540)
,p_plug_template_id=>wwv_flow_imp.id(294301809631215843)
,p_name=>'Close'
,p_placeholder=>'CLOSE'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(319888215662547541)
,p_plug_template_id=>wwv_flow_imp.id(294301809631215843)
,p_name=>'Copy'
,p_placeholder=>'COPY'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(319888701143547542)
,p_plug_template_id=>wwv_flow_imp.id(294301809631215843)
,p_name=>'Create'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(319889201846547542)
,p_plug_template_id=>wwv_flow_imp.id(294301809631215843)
,p_name=>'Edit'
,p_placeholder=>'EDIT'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(319889726253547543)
,p_plug_template_id=>wwv_flow_imp.id(294301809631215843)
,p_name=>'Next'
,p_placeholder=>'NEXT'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(319890233542547543)
,p_plug_template_id=>wwv_flow_imp.id(294301809631215843)
,p_name=>'Previous'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(319890676520547544)
,p_plug_template_id=>wwv_flow_imp.id(294301809631215843)
,p_name=>'Sub Regions'
