...
wwv_flow_imp_shared.create_template(
 p_id=>wwv_flow_imp.id(294247086726215776)
,p_theme_id=>42
,p_name=>'Drawer'
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(319740088334547375)
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(319740631771547375)
,p_page_template_id=>wwv_flow_imp.id(294247086726215776)
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(319741155930547376)
,p_page_template_id=>wwv_flow_imp.id(294247086726215776)
