...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(294318705592215863)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(319930018152547599)
,p_plug_template_id=>wwv_flow_imp.id(294318705592215863)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(319930567521547600)
,p_plug_template_id=>wwv_flow_imp.id(294318705592215863)
,p_name=>'Sub Regions'
