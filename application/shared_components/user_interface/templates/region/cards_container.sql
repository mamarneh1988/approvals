...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(294290063204215835)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(319855003918547497)
,p_plug_template_id=>wwv_flow_imp.id(294290063204215835)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(319855547499547497)
,p_plug_template_id=>wwv_flow_imp.id(294290063204215835)
,p_name=>'Sort Order'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(319856033293547497)
,p_plug_template_id=>wwv_flow_imp.id(294290063204215835)
,p_name=>'Sub Regions'
