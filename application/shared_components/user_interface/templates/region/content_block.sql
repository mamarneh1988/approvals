...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(294311358452215853)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(319911282333547572)
,p_plug_template_id=>wwv_flow_imp.id(294311358452215853)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(319911801774547573)
,p_plug_template_id=>wwv_flow_imp.id(294311358452215853)
,p_name=>'Change'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(319912273816547574)
,p_plug_template_id=>wwv_flow_imp.id(294311358452215853)
,p_name=>'Edit'
,p_placeholder=>'EDIT'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(319912806671547574)
,p_plug_template_id=>wwv_flow_imp.id(294311358452215853)
,p_name=>'Next'
,p_placeholder=>'NEXT'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(319913279982547575)
,p_plug_template_id=>wwv_flow_imp.id(294311358452215853)
,p_name=>'Previous'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(319913792576547575)
,p_plug_template_id=>wwv_flow_imp.id(294311358452215853)
,p_name=>'Sub Regions'
